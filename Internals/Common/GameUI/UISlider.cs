...
namespace WiiPlayTanksRemake.Internals.Common.GameUI
{
    internal class UISlider : UIElement
    {
		public float Value
		{
			get => InternalValue; set => InternalValue = MathHelper.Clamp(value, 0f, 1f);
		}
		...
		{
			UIImage interactable = new UIImage(GameResources.GetGameResource<Texture2D>("Assets/MagicPixel"), 1f, (image, spriteBatch) => spriteBatch.Draw(image.Texture, image.Hitbox, SliderColor));
		...
		public override void DrawSelf(SpriteBatch spriteBatch)
		{
			...
			spriteBatch.Draw(GameResources.GetGameResource<Texture2D>("Assets/MagicPixel"), Hitbox, Color.DeepSkyBlue);
		}
